...
**次の能動アクション**: `v0.1.0-beta.10` を業務並走で使い込み、業務凍結級バグが出なければ
v1.0 stable へ。上記 3〜5 は v1.0 までの課題として随時着手。
